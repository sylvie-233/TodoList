...
<style scoped>
.tag-selector { padding: 12px 0; }
.tag-dot { width: 12px; height: 12px; border-radius: 50%; margin-right: 10px; display: inline-block; vertical-align: middle; }
.empty-tags { text-align: center; padding: 20px; color: var(--color-text-hint); font-size: var(--font-size-sm); }
</style>
